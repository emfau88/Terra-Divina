...
export const BALANCE = {
  ...
  FOUND_VILLAGE_WOOD_COST: 180,
  FOUND_VILLAGE_FOOD_COST: 90,
  FOUND_VILLAGE_MIN_LEVEL: 4,
  FOUND_VILLAGE_MIN_POP: 18,
  FOUND_VILLAGE_MAX_PER_FACTION: 2,
  FOUND_VILLAGE_MIN_DISTANCE: 16,
